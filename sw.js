/* GENERADO por scripts/build-sw.mjs (mscan-20260926170517) — NO editar a mano.
...
const KEY = 'mscan-20260926170517';
const SHELL = KEY + '-shell';
const RUNTIME = KEY + '-runtime';
const PRECACHE = [
  "f4/test-harness-f4device.html",
  "f4/assets/detection.worker-cPCHOpMB.js",
  "f4/assets/test-harness-f4device-B-rKE6ym.js",
  "f5/test-harness-f5device.html",
  "f5/assets/detection.worker-cPCHOpMB.js",
  "f5/assets/pdfExport-Cbr_t6PA.js",
  "f5/assets/test-harness-f5device-CgfMJ0DJ.js",
